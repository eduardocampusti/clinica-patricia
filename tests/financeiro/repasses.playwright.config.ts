...
export default defineConfig({
  ...
  webServer: {
    command: 'npm.cmd run dev -- --config tests/financeiro/vite.config.ts --host 127.0.0.1 --port 4182 --strictPort',
    url: 'http://127.0.0.1:4182/tests/financeiro/repasses.html', reuseExistingServer: false,
  },
})
